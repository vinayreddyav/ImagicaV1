...
{
    public class PostProcessingRulesRepository : IPostProcessingRulesRepository
    {
        
        private DatabaseContext  _collections;

        public PostProcessingRulesRepository() { }
        public PostProcessingRulesRepository(string connectionString, string databaseName)
        {
