...
using PostProcessingRules.Persistence;
using System.Globalization;


namespace PostProcessingRules.API.Controllers
{
    
    [Route("api/[controller]")]
    
    public class PostProcessingRulesController : Controller
    {
        private ConfigSettings _config;
        private IPostProcessingRulesRepository _repository;
       
        public PostProcessingRulesController(ConfigSettings config)
        {
            _config = config;
            _repository = new PostProcessingRulesRepository(_config.ConnectionString, _config.DatabaseName);
